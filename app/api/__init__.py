...
all_routers.include_router(description_router, prefix="/admin/description", tags=["description"])

all_routers_v2 = APIRouter()
all_routers_v2.include_router(description_router_v2, prefix="/admin/description", tags=["description"])
